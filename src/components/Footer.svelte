<!-- <footer class="bg-white text-gray-800 py-4 bottom-0 left-0 right-0 w-full">
  <div class="container mx-auto text-center flex flex-col justify-center items-center space-y-2">
    <div class="flex items-center space-x-2">
      <span class="flex items-center space-x-1">
        ...
        &nbsp;by Fares Aboud Heswani -
      </span>
      <a href="https://www.linkedin.com/in/fares-aboud-heswani-479640227/" target="_blank" class="text-blue-400 flex items-center space-x-1 hover:text-blue-600">
        <span>LinkedIn</span>
    ...
    <div class="flex flex-col items-center space-y-2">
      <p>Web Development 2 by Prof. <a href="https://www.linkedin.com/in/laborci/" target="_blank" class="text-blue-400 hover:text-blue-600">Gergely Laborci</a></p>
    </div>
  </div>
</footer>
...
<footer class="bg-white text-gray-800 py-4 bottom-0 left-0 right-0 w-full">
  <div class="container mx-auto text-center flex flex-col justify-center items-center space-y-2 px-4">
